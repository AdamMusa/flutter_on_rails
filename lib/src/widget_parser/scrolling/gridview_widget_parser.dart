...
class GridViewWidgetParser extends WidgetParser {
  ...
  Widget parse(
    ...
    double? mainAxisSpacing =
        map.containsKey('mainAxisSpacing')
            ? map['mainAxisSpacing']?.toDouble()
            : 0.0;
    double? crossAxisSpacing =
        map.containsKey('crossAxisSpacing')
            ? map['crossAxisSpacing']?.toDouble()
            : 0.0;
    double? childAspectRatio =
        map.containsKey('childAspectRatio')
            ? map['childAspectRatio']?.toDouble()
            : 1.0;
    var children = WidgetParserBuilder.buildWidgets(
      map['children'],
      buildContext,
      listener,
    );
...
class _GridViewWidgetState extends State<GridViewWidget> {
  ...
  //     var buildWidgets = WidgetParserBuilder.buildWidgets(

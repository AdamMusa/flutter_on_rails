...
import 'package:flutter_on_rails/src/widget_parser/drop_cap_text.dart';
...
class DropCapTextParser extends WidgetParser {
  ...
  Widget parse(
    ...
    return DropCapText(
      ...
      dropCapStyle:
          map.containsKey('dropCapStyle')
              ? parseTextStyle(map['dropCapStyle'])
              : null,
      textAlign:
          map.containsKey('textAlign')
              ? parseTextAlign(map['textAlign'])
              : TextAlign.start,
      dropCap:
          map.containsKey('dropCap')
              ? parseDropCap(map['dropCap'], buildContext, listener)
              : null,
      dropCapPadding:
          map.containsKey('dropCapPadding')
      ...
      parseInlineMarkdown:
          map.containsKey('parseInlineMarkdown')
